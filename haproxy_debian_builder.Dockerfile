...
ARG jemalloc_latest_commit_hash=2c0f4c2ac3b6a78a849526be384a7a2349d1a09c
# WORKDIR /build_root
# RUN source '/root/.bashrc' \
...
ARG haproxy_latest_commit_hash=f4edd378d2c6bd8e3ebcaf29204cdade7f8c8266
